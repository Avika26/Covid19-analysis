...
├── covid19.pbit         # Power BI dashboard template
...
> *This is my first Power BI project — built while learning and exploring the tool from scratch.*

An interactive 5-page COVID-19 global dashboard built in Power BI Desktop, extending the Python analysis into a fully interactive visual experience.

### Dashboard Pages

| Page | Description |
|---|---|
| Global Overview | KPI cards, animated bubble map, global case trend line |
| Trends Over Time | Wave analysis, cases vs deaths dual-axis, continent breakdown |
...
- Omicron (Jan 2022) was the **largest wave of the entire pandemic** by case count
- **Europe had the highest cases per million** globally among all continents
- Countries with **older median age** showed significantly higher deaths per million
- **Africa had the lowest average diabetes prevalence** among all continents
- **USA & China** led in total case counts worldwide

### Power BI Features Implemented

-  Sync slicers across all 5 pages
-  Field parameters for dynamic metric switching (Cases / Deaths / CFR / Cases per Million)
-  Drillthrough to country-level detail page
-  Bookmarks for scatter plot view toggling
-  Custom sidebar page navigation
-  Reset filters button
-  Conditional formatting on visuals

### How to Use

1. Download `COVID19_Dashboard.pbit` from this repo
2. Open in **Power BI Desktop** (free download from Microsoft)
3. When prompted, connect to the OWID dataset: [Our World in Data – COVID-19](https://ourworldindata.org/covid-deaths)
4. Explore all 5 pages interactively
